...
LastEditTime: 2020-11-21 11:07:44
LastEditors: jirufengyu
Description: Nothing
FilePath: /Signal-1/DQN_Word_Problem_Solver/env.py
'''
from utils import *
from config import *
from agent import *
...
class Env:
    ...
    def val_step(self, action_op, loc):
        next_states, done, flag, etime = self.curr_agent.compound_two_nodes_predict(action_op, loc, '/home/stu2/Signal-1/DQN_Word_Problem_Solver/predict/analysis_')
