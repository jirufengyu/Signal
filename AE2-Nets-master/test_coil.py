...
LastEditTime: 2020-10-21 01:28:02
...
if __name__ == '__main__':
    ...
    v1_aedims_ = [[x1.shape[1], 1024,512],[512,1024,x1.shape[1]]]
    
    v2_aedims_ = [[x2.shape[1], 1024,512],[512,1024,x2.shape[1]]]
    #原来的
    mae_dims_=[[512,256,128],[512,256,128],[128,256,512],[128,256,512]]
    #现在用的
    #dims_dg1 = [64, 100]
    #dims_dg2 = [64, 100]
    dis_dims_=[512,256,100,1]
    para_lambda = 1
    batch_size = 100
