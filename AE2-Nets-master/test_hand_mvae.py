...
LastEditTime: 2020-10-29 13:54:10
LastEditors: jirufengyu
Description: In User Settings Edit
FilePath: /Signal-1/AE2-Nets-master/test_hand_mvae.py
'''
from utils.Dataset import Dataset
from MVAE import MaeAEModel
...
if __name__ == '__main__':
    ...
    #原来的
    mae_dims_=[[240,200,150,32],[216,200,150,32],[32,150,200,240],[32,150,200,216]]
    #现在用的
    #dims_dg1 = [64, 100]
    #dims_dg2 = [64, 100]
    dis_dims_=[200,150,1]
