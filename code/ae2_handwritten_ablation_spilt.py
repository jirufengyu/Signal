...
ae net need pre-training before the whole optimization
'''
if __name__ == '__main__':
    ...
    for j in range(num):
        ...
        H, gt = model_spilt(x1, x2, gt, para_lambda, dims, act, lr, epochs, batch_size)
    ...
    files = open('./result/result_hand_ablation_spilt.csv', 'a')
